...
def submitted_form():
    if request.method == 'POST':
        ...
        FluenceOutput, plot1, plot2, plot3 = fl_dist_over_large_distances(P,d0,t1,dp1,dh1,t2,dp2,dh2)
    else:
        FluenceInput = None
        FluenceOutput = None
        plot1 = None
    ...
    return render_template('submitted_form.html',FluenceInput=FluenceInput,FluenceOutput=FluenceOutput, plot1=plot1, plot2=plot2, plot3=plot3)
